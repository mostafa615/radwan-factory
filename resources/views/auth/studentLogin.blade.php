    ...
    <div class="row justify-content-center">
        <div>
                ...
                <div class="login-box" style="width: 390px;">
                    ...
                    <img style="width:200px;" src="{{ asset('dashboard/images/login/logo.png') }}" class="w3-center w3-round"  width="90px" >
                    <br>
                    {{-- <h1 style="color: black"  class="w3-text-white" ><b> @lang('site.fcis-medical')  </b></h1> --}}
                    <h4 style="color: white;"  class="w3-text-white" ><b> Radwan Steel</b></h4>
                        </div>
                            {{-- <p class="login-box-msg" style='color: white;'>@lang('site.regist-on-your-dashboard')</p> --}}
                            <!--<br>-->
                            {{-- <p class="login-box-msg" style="color: red">@lang('site.login-not2')</p> --}}
                            {{-- <p class="login-box-msg" style='color: white;'>@lang('site.login-not3')</p> --}}
