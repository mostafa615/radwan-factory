    ...
    <div class="box box-primary">
      <div class="box-header">
        <div class="row">
          ...
          <label class="col-md-4">{{ $operationOrderResult->operationOrder->id }} ->
            {{$operationOrderResult->order_details_id}}</label>
      ...
      <div class="box-body">
        ...
        <table class="table table-responsive table-bordered">
          <thead>
            <tr>
              ...
              <td>رصيد الخامة المستخدمة بعد التشغيل</td>
              <td>ناتج الخامة المستخدمة</td>
              <td>الخامة الناتجة</td>
              <td>رصيدالخامة الناتجة بعد التشغيل</td>
              {{-- <td>اسم الناتج</td> --}}
              <td>الناتج الفعلي</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$operationOrderDetail->new_in_balance}}</td>
              <td>{{optional($operationOrderResult)->old_item_quantity}}</td>
              <td>{{optional($itemName)->name}}</td>
              <td>{{$operationOrderDetail->new_out_balance}}</td>
        ...
        <br>
        @if ($operationOrderResult->store_confirm_notes)
          <p>ملحوظة المخزن : {{ optional($operationOrderResult)->store_confirm_notes}}</p>
        @endif
        <br>
        <table class="table table-responsive table-bordered">
          <thead>
          ...
          <tbody>
            ...
            $OrderResultDetails =
            App\OperationOrderResultDetail::where('order_results_id',$operationOrderResult->id)->get();
            @endphp
        ...
        <table class="table table-responsive table-bordered">
          <thead>
            <tr>
              <td>اسماء العاملين على ناتج أمر التشغيل</td>
            </tr>
          </thead>
          <tbody>
            <?php
              $storeEmployeesIds = explode(',', $operationOrderResult->store_employees);
