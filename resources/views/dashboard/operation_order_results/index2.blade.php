    ...
    <div class="content-wrapper">
        ...
        <section class="content" style='padding-bottom: 0px !important;'>
            ...
            <div class="box box-primary">
                            ...
                            <div class="col-md-4">
                                @if (Auth::user()->can('create_operation_order_results'))
                                    <a href=" {{ route('dashboard.operation_order_results.create') }}"
                                        class="btn btn-success"><i class="fa fa-plus"></i> @lang('site.add')</a>
                                @endif
                            </div>
                        </div>
                    </form>
                ...
                <div class="box-body">
                    <form action="{{ route('dashboard.operation_order_results.updateConfirm') }}" method="Post"
                        id="updateForm">
                        @csrf
...
@section('scripts')
    <script>
        ...
        function setOperationOrderResultDataTable() {
            var url = "{{ route('dashboard.operation_order_results.operation_order_results_Datatable') }}?type=not_all";
