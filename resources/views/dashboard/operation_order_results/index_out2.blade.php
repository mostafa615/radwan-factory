    ...
    <div class="content-wrapper">
        ...
        <section class="content" style='padding-bottom: 0px !important;'>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form action="{{ route('dashboard.operation_order_results.updateConfirmOut') }}" method="Post"
                        id="updateForm">
                        @csrf
...
@section('scripts')
    <script>
        ...
        function setOperationOrderResultDataTable() {
            var url = "{{ route('dashboard.operation_order_results.operation_order_results_Datatable_out') }}?type=not_all";
