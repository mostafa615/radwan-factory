    ...
    <div class="content-wrapper">
            <section class="content-header">
                ...
                <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
                    <li class="active">ناتج أمر التشغيل</li>
                </ol>
            </section>
            <section class="content" style='padding-bottom: 0px !important;'>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title" style="margin-bottom: 15px">ناتج أمر التشغيل</h3>
                        <form action="{{ route('dashboard.operation_order_results.index')}}" method="GET">
                            <div class="row">
                                {{-- <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    @if (Auth::user()->can('create_operation_order_results'))
                                        <a href=" {{route('dashboard.operation_order_results.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> @lang('site.add')</a>
                                    @endif
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="box-body">
                        <form action="{{ route('dashboard.operation_order_results.updateConfirm')}}" method="Post" id="updateForm">
                            @csrf
...
<script>
    ...
    function setOperationOrderResultDataTable() {
        var url = "{{ route('dashboard.operation_order_results.operation_order_results_Datatable') }}";
