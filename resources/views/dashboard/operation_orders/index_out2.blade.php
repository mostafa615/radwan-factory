    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> أوامر التشغيل الخارجية</li>
            </ol>
        </section>
        <section class="content" style='padding-bottom: 0px !important;'>
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title" style="margin-bottom: 15px"> أوامر التشغيل الخارجية</h3>
                    <form action="{{ route('dashboard.operation_orders.index_out') }}" method="GET">
                        <div class="row">
                            {{-- <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                @if (Auth::user()->hasRole('machine_response'))
                                    <a href=" {{ route('dashboard.operation_order_results.create_out') }}"
                                        class="btn btn-success"><i class="fa fa-plus"></i> إضافه ناتج امر تشغيل خارجى</a>
                                @endif
                            </div>
                        </div>
                    </form>
...
@section('scripts')
    <script>
        ...
        function setOperationOrderDatatable() {
            var url = "{{ route('dashboard.operation_orders.operation_orders_Datatable_out') }}?type=not_all";
