                    ...
                    <div class="box-header with-border">
                        ...
                        <form action="{{ route('dashboard.operation_orders.index_out')}}" method="GET">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('store_respons') || Auth::user()->hasRole('store_factor_response'))
...
<script>
    ...
    function setOperationOrderDatatable() {
        var url = "{{ route('dashboard.operation_orders.operation_orders_Datatable_out') }}";
