...
<div class="content">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <br>
            @if ($operationOrder->out_operation == 1)
                <p>ملحوظة المسؤول : {{ optional($operationOrder)->confirm_notes}}</p>
            @endif
            <br>
            @if (!$operationOrder->item_id)
            <table class="table table-responsive table-bordered">
                <thead>
                    <tr>
                        ...
                        @endif
                        <td>مستلزمات التشغيل</td>
                        <td>كمية المستلزم المستخدمة</td>
                        <td>كمية المستلزم قبل التشغيل</td>
                        <td>المتبقي من المستلزم الآن</td>
                        @if ($operationOrder->out_operation == 0)
                        <td>صنف سابق</td>
                        <td>رصيد الخامة الناتجة قبل التشغيل</td>
                        @endif
                        @if ($operationOrder->out_operation == 1)
