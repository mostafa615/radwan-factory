            ...
            <section class="content">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{route('dashboard.specials.store')}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('post') }}
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="@lang('site.name')*" type="text" name="name" id="name" class="form-control" value="م خ " required>
                            ...
                            <div class="form-group">
                                <label>الطول *</label>
                                <input placeholder="الطول" type="number" step="any" min="0" name="length" class="form-control" value="{{old('length')}}" required>
                            </div>
                            <div class="form-group">
                                <label>العرض *</label>
                            ...
                            <!--<div class="form-group">-->
                            <!--    <label>الكمية *</label>-->
                            <!--    <input placeholder="الكمية" type="number" step="any" min="0" name="quantity" class="form-control" value="0" required>-->
                            <!--</div>-->
                            ...
                            <!--</div>-->
                             ...
                             <div class="form-group">
                                <label>الكمية *</label>
                                <input placeholder="الكمية" type="number" step="any" min="0" name="quantity" class="form-control" value="{{old('quantity')??0}}" @if (!auth::user()->hasRole('admin'))
                                 readonly
                                @endif required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>@lang('site.price')*</label>
                                <input type="number" name="price" class="form-control" placeholder="السعر" value="{{old('price')??0}}" @if (!auth::user()->hasRole('admin'))
                                readonly
                                @endif required>
                            </div>
